...
/**
 * Adding a tool to the register, or correcting one [BLUEPRINT §28].
 *
 * Lifted out of the register list so the detail page edits through this same form. Two copies of
 * a form over thirty fields is two forms that drift, and the one somebody stops maintaining is
 * the one that quietly stops saving a field.
 *
 * Everything to the right of the divider is derived live from the four figures to its left —
 * cavities, part weight, runner weight, cycle — so the person entering them watches the
 * consumption move as they type, and the gap between what a piece weighs and what it consumes
...
export default function MouldForm({ mould, onClose, onSaved }) {
